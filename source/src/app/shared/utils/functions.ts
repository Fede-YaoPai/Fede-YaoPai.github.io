...
export const getLoggedUserFromUser = (u: User): LoggedUser => ({id: u.id, name: u.name, lastname: u.lastname, username: u.username, sex: u.sex, amountLoaned: u.amountLoaned});
